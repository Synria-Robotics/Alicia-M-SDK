...
def precise_sleep(seconds: float, spin_threshold: float = 0.002, sleep_margin: float = 0.001):
    ...
    :param spin_threshold: if remaining <= spin_threshold -> spin; otherwise sleep (seconds). Default 2ms
    :param sleep_margin: when sleeping leave this much time before deadline to avoid oversleep. Default 1ms
